...
const confusionMatrixData = [
  ...
  ["§ 126 StGB", 2, 3, 7, 100, 17, 4, 8, 9, 500, 25, 0, 1, 3, 5],
  ["§ 130 StGB", 4, 5, 7, 7, 413, 9, 7, 8, 19, 9, 0, 0, 2, 6],
  ["§ 131 StGB", 1, 6, 8, 6, 14, 150, 6, 7, 49, 30, 0, 0, 1, 183],
  ["§ 140 StGB", 3, 3, 199, 5, 5, 7, 260, 6, 180, 10, 3, 0, 0, 6],
  ["§ 166 StGB", 2, 3, 8, 6, 1, 7, 8, 230, 19, 50, 2, 2, 0, 7],
  ["§ 185 StGB", 1, 7, 8, 7, 0, 6, 7, 8, 582, 199, 1, 1, 0, 8],
  ["§ 186 StGB", 1, 8, 8, 6, 4, 5, 6, 6, 150, 502, 5, 1, 0, 8],
